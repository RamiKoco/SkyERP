    ...
    public class GenelAmacliRaporBll : BaseBll<Tahakkuk,ERPContext>
    {
        public IEnumerable<GenelAmacliRaporL> List(Expression<Func<Tahakkuk, bool>> filter)
        {
            ...
            }).Select(x => new GenelAmacliRaporL
            {
                ...
                KimlikIlAdi = x.Tahakkuk.Ogrenci.KimlikIl.Ad,
                KimlikIlceAdi = x.Tahakkuk.Ogrenci.KimlikIlce.Ad,
                ...
                VeliEvAdresIlAdi = x.VeliBilgileri.Iletisim.EvAdresIl.Ad,
                VeliEvAdresIlceAdi = x.VeliBilgileri.Iletisim.EvAdresIlce.Ad,
                VeliIsAdres = x.VeliBilgileri.Iletisim.IsAdres,
                VeliIsAdresIlAdi = x.VeliBilgileri.Iletisim.IsAdresIl.Ad,
                VeliIsAdresIlceAdi = x.VeliBilgileri.Iletisim.IsAdresIlce.Ad,
